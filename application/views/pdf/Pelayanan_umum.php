...
$pdf->SetAuthor($data->NAMA_PEMOHON);
$pdf->SetTitle('Form Permohonan Pelayana Umum');
$pdf->SetSubject('Form Permohonan Pelayana Umum');
$pdf->SetKeywords('Form Permohonan Pelayana Umum');
...
$txt = <<<EOD
FORMULIR PERMOHONAN PELAYANAN UMUM
REGIONAL 2 BENGKULU
EOD;
...
$pdf->Write(0, "NOMOR : ".$data->NOMOR_UMUM, '', 0, 'C', true, 0, false, false, 0);
$pdf->Write(0, "", '', 0, 'C', true, 0, false, false, 0);
$pdf->SetFont('times', '', 16);
$html='<table border="1">
                  <tr>
                    <td width="40%">Nama Pemohon/User</td>
                    <td width="5%">:</td>
                    <td width="65%">'.$data->NAMA_PEMOHON.'</td>
                  </tr>
                  <tr>
                    <td >Jabatan</td>
                    <td >:</td>
                  ...
                  <tr><td></td></tr>
                  <tr>
                    <td >Permohonan Pelayana  Umum</td>
                    <td >:</td>
                    <td >'.$data->PERMOHONAN_UMUM.'</td>
                  </tr>
                  <tr>
                    <td >Pada hari/Tanggal</td>
                    <td >:</td>
                    <td >'.tgl_indo($data->DATE_UMUM).'</td>
                  </tr>
                  <tr>
                    <td >Bentuk Permohonan</td>
                    <td >:</td>
                    <td >'.$data->BENTUK_UMUM.'</td>
                  </tr>
                  <tr>
...
$pdf->writeHTMLCell(100, 100, 5, 170, $ttd, $border=0, $ln=0, $fill=0, $reseth=true, $align='center', $autopadding=true);
          ...
          $ttd='<table  style="margin-top:0px;height10 px;margin-left:0px;" width="90%"   align="center" >
            ...
            <tr>
              <td align="center" align="center"><U>'.$data->NAMA_PEMOHON.'</U></td>
            </tr>
            <tr>
              <td align="center" align="center">'.$data->NIPP.'</td>
            </tr>    
          </table>';

$pdf->writeHTMLCell(103, 50, 110, 170, $ttd, $border=0, $ln=0, $fill=0, $reseth=true, $align='center', $autopadding=true);
...
$pdf->writeHTMLCell(103, 50, 55, 215, $ttd, $border=0, $ln=0, $fill=0, $reseth=true, $align='center', $autopadding=true);
