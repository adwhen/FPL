        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-8">
              ...
              <label><h3>I. IDENTITAS PEMINJAM</h3></label>
              <!-- /.form-group -->
              ...
              <label><h3>III. PINJAM KENDARAAN OPERASIONAL</h3></label>
              <div class="form-group">
                <label>JENIS KENDARAAN</label>
                <select readonly class="form-control" name="PINJAM_KENDARAAN" id="PINJAM_KENDARAAN">
                            <option value="">Choose</option>
                    <?php foreach($jenis_kendaraan as $jk){?>
                            <option <?php if($jk->NAMA_JK==$data->PINJAM_KENDARAAN){echo "selected";} ?>><?=$jk->NAMA_JK?></option>
                    <?php } ?>
                </select>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label>KM AWAL</label>
                <input readonly type="text" name="SPEEDO_AWAL" id="SPEEDO_AWAL" class="form-control" value="<?=$data->SPEEDO_AWAL?>">
              </div>
              <div class="form-group">
            ...
            <div class="col-md-4">
              ...
              <table id="table_w3s" style="font-size: 10;">
                ...
                <tr>
                  ...
                  <td><?=$h->NIPP?></td>
                  <td><?=$h->KOMENTAR?></td>
                  <td><?php if($h->STATUS=="PASS"){echo "APPROVED";}else{
                    echo $h->STATUS;
                  }  ?></td>
                </tr>
              <?php } ?>
