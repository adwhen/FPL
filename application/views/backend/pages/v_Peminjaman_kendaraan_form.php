        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-8">
              ...
              <div class="form-group">
                <label>KM AWAL</label>
                <input type="text" name="SPEEDO_AWAL" id="SPEEDO_AWAL" class="form-control">
              </div>
              <div class="form-group">
                <label>KM AKHIR</label>
                <input type="text" name="SPEEDO_AKHIR" id="SPEEDO_AKHIR" class="form-control" placeholder="Diisi Setelah Pengambalian" readonly>
              </div>
            </div>
            <!-- /.col -->
            <div class="col-md-4">
