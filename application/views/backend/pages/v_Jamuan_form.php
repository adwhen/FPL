            ...
            <div class="row">
              <div class="col-md-8">
                ...
                <div class="form-group">
                  <label>WAKTU</label>
                  <div class="row">
                    <div class="col-md-5"><input type="TIME" name="WAKTU_AWAL" id="WAKTU_AWAL" class="form-control"></div>
                    <div class="col-md-1"><B>Sampai</B></div>

                    <div class="col-md-5"><input type="TIME" name="WAKTU_AKHIR" id="WAKTU_AKHIR" class="form-control"></div>
                  </div>
