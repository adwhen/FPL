          ...
          <div class="row">
            <div class="col-md-8">
              ...
              <div class="form-group">
                ...
                <input type="text" name="USER" id="USER" class="form-control" value="<?=$data->NAMA_A?>">
              </div>
              <div class="form-group">
                <label>JABATAN</label>
              ...
              <div class="form-group">
                <label>Jenis SPPD</label>
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" value="DINAS HARIAN" name="JENIS_SPPD[]" <?php if(count($dinas_harian)>0){echo "checked";} ?> >
                      DINAS HARIAN
                    </label>     
                  </div>
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" value="DIKLAT" name="JENIS_SPPD[]" <?php if(count($diklat)>0){echo "checked";} ?> >
                      DIKLAT
                    </label>
                  </div>
                </div>
