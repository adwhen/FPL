  ...
  <div class="container">
    ...
    <section class="content">
      <div class="box box-default">
        ...
        <!-- /.box-header -->
        <form method="POST" action="<?= base_url('index.php/Master/save_employee') ?>" enctype="multipart/form-data" id="form_E">
          <div class="box-body">
            <div class="row">
              <div class="col-md-12">
                <!-- /.form-group -->
        ...
        <div class="form-group">
                  ...
                  <button class="btn btn-danger" onclick="back_e()" type="button">Back</button>
