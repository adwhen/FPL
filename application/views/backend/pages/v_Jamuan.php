    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header">
          <center>
            <h3 class="box-title">Pelayanan Jamuan</h3>
          </center>
        </div>
        <hr>
        <div class="box-header">
          <a class="btn btn-success" href="<?= base_url('index.php/Reception/form') ?>">Ajukan Jamuan</a>
          <?php if ($this->session->userdata('status') == 1) { ?><a class="btn btn-warning" href="<?= base_url('index.php/Reception/report') ?>">Laporan</a><?php } ?>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
...
<script type="text/javascript">
  ...
  function save_pel(idx) {
    ...
    $.post('<?= base_url('index.php/Reception/approval/') ?>', {
        IDX: idx,
        KOMENTAR: komentar,
        STATUS: status
      },
